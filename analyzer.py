...
# 設定：ここを変えて遊ぶ
TARGET_QUERY = "トヨタ自動車 株価"  # ニュースを探すキーワード
RSS_URL = f"https://news.google.com/rss/search?q={TARGET_QUERY}&hl=ja&gl=JP&ceid=JP:ja"
DB_FILE = "data.json"
